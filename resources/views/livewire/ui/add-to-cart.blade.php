                    ...
                    <tr>
                        <td>
                            <div class="flex items-center">
                                ...
                                <span class="font-medium w-12 h-12 mr-4 text-black"> {{ $item['name'] }}</span>
                            </div>
                        </td>
                        <td>{{ $item['price'] }}</td>
                        <td>
                        ...
                        <td class="@if (app()->getLocale() == 'ar') text-left @else text-right   @endif">{{ $item['price'] * $item['quantity'] }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
