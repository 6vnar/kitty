        ...
        <div class="flex-shrink-0 m-6 relative overflow-hidden bg-[#fb97ac] rounded-lg max-w-xs shadow-lg">
            ...
            <div class="relative text-white px-6 pb-3 mt-3">
                ...
                <div class="flex justify-between">
                    ...
                    <span class="block bg-white rounded-full text-orange-500 text-xs font-bold px-3 py-2 leading-none flex items-center">${{ $product->price }}
                    </span>
                </div>
            </div>
            <div class="relative text-white px-3 pb-6 mt-3">
                <a href="{{ route('show_product', $product->id) }}" class="bg-pink-500 hover:bg-pink-600 text-white font-bold py-2 px-4 rounded">{{ __('ui.View') }}</a>
            </div>
        </div>
    </div>
</div>