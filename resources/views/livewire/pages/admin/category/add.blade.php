<div>
	@section('title', __('ui.Add category'))
	<div class="grid  grid-cols-2	justify-center items-center w-full  ">
			...
			<form class="w-full " wire:submit.prevent="add">
				<div class="mx-auto flex">
					<div class=" relative z-0 mb-6 w-full">
						<label for="text" class="text-sm text-navy-700 dark:text-white font-bold">{{__('ui.Category Name')}}</label>
				...
				<div class=" relative items-center  justify-center ">
					<label class="w-full h-40 hover:text-gray-900 flex flex-col items-center px-4 py-6  text-pink rounded-lg shadow-inner grayy  tracking-wide uppercase border border-blue cursor-pointer">
						...
						<input  wire:model="name" type='file' class="absalote hidden" />
					</label>
				</div>
		...
		<div class="p-6 m-6">
			<img class=" h-auto ml-7"  src="{{ asset('images/category/categ2.jpg') }}" />
		</div>
	</div>
</div>