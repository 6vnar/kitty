    <div class="px-4 md:px-8 xl:px-12   bg-white text-gray-800 ">
        <div class="flex mx-auto justify-center mt-6  pt-9">
            ...
            <div class="cursor-pointer justify-center xl:mr-4 flex">
                <a href="{{ route('addadmin') }}" class="text-black text-md xl:text-xl duration-200 bg-primary-500 hover:bg-white border border-transparent hover:border-gray-500 hover:text-primary-500 focus:ring-4 focus:ring-primary-300 rounded-lg px-3 py-2 md:px-5 md:py-2.5">
