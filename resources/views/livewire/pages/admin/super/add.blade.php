        ...
        <form wire:submit.prevent="save" class="mx-6 px-6 mt-6">
            <div class=" mx-6 px-6 flex-rows w-full mt-6  justify-center ">
                    <div class="grid xl:grid-cols-2 w-full gap-6 ">
                        <div class=" mb-6  ">
                            <label for="text" class="text-sm text-navy-700 dark:text-white font-bold">{{__('ui.Name')}}</label>
                        ...
                        <div class=" mb-6 ">
                            <label for="text" class="text-sm text-navy-700 dark:text-white font-bold">{{__('ui.address')}}</label>
                        ...
                        <div class=" mb-6 ">
                            <label for="text" class="text-sm text-navy-700 dark:text-white font-bold">{{__('ui.Email')}}</label>
                        ...
                        <div class=" mb-6 ">
                            <label for="text" class="text-sm text-navy-700 dark:text-white font-bold">{{__('ui.Password')}}</label>
                        ...
                        <div class=" mb-6 ">
                            <label for="text" class="text-sm text-navy-700 dark:text-white font-bold">{{__('ui.phone_number')}}</label>
