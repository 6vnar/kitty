<div>
	...
	<div class="max-w-7xl mt-6 mx-auto py-6 sm:px-6 lg:px-8">
		<div class="bg-[#fbdddf]  overflow-hidden  mt-6 shadow-inner sm:rounded-lg">
			<div class="  p-6 ">
				<form>
